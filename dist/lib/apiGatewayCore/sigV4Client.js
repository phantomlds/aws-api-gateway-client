...
var _sha=require('crypto-js/sha256');var _sha2=_interopRequireDefault(_sha);
var _encHex=require('crypto-js/enc-hex');var _encHex2=_interopRequireDefault(_encHex);
var _hmacSha=require('crypto-js/hmac-sha256');var _hmacSha2=_interopRequireDefault(_hmacSha);
...
var datetime=new Date(new Date().getTime()+config.systemClockOffset).toISOString().
...
var credentialScope=buildCredentialScope(
datetime,
...
var signingKey=calculateSigningKey(
